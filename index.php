...
<head>
	...
	<title>MCRad.io Coming Soon</title>
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section class="slogan fade-down">
			<h1>Our website is under construction. We`ll be here soon with some amazing music and shows!</h1>			
		</section>
		<!-- Slogan end here -->
		...
		<section class="count-down-wrapper fade-down">
			<ul class="row count-down">                       
				<li class="col-md-3 col-sm-6">   
					<input class="knob days" data-readonly=true data-min="18" data-max="365" data-width="260" data-height="260" data-thickness="0.07" data-fgcolor="#34aadc" data-bgColor="#e1e2e6" data-angleOffset="180">
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; MCRad.io 2016, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
